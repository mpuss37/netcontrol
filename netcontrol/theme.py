...
Pilihan tema disimpan di ~/.netcontrol/netcontrol.conf supaya tetap
tersimpan saat aplikasi dibuka ulang.
"""
import os
from pathlib import Path

CONFIG_DIR = os.path.join(str(Path.home()), '.netcontrol')
CONFIG_FILE = os.path.join(CONFIG_DIR, 'netcontrol.conf')
